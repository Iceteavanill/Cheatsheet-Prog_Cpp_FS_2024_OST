...
%Layout
\usepackage{multicol, geometry, tcolorbox, fancyhdr ,lastpage, dirtytalk, qrcode}
% mehrere spalten, page layout, farbboxen der titel, header/footer, linkt to last page, make the use of "" easier, QR code im Titel
\geometry{margin=1cm}
\parindent 0pt
\pagestyle{fancy}
\newlength{\breite}
