...
Templates erlaubt es code Typen-unabhängig zu schreiben. 
...
Um zu signalisieren, ob eine Funktion eine Exception auslösen kann oder nicht, kann der specifier \say{noexept} verwendet werden. 
